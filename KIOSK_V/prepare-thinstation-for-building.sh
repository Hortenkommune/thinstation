...
sed -i "s@USERSTRING@${SMBUSER}%${SMBPASSWD}@g" /thinstation/build/packages/autoscrotter/bin/autoscrotter.sh
sed -i "s@SMBSTRING@${SMBSTRING}@g" /thinstation/build/packages/autoscrotter/bin/autoscrotter.sh
